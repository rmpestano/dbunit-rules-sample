...
[source,java,linenums]
----
include::{sourcedir}/com/github/dbunit/rules/sample/EntityManagerProducer.java[]
----
...
[source,java,linenums]
----
include::{sourcedir}/com/github/dbunit/rules/sample/DBUnitRulesCDITest.java[tags=sample]
}
----
...
[source,java,linenums]
----
include::{sourcedir}/com/github/dbunit/rules/sample/DBUnitRulesCDITest.java[tags=expectedCDI]
----
